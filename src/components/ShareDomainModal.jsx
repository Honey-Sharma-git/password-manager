...
export const ShareDomainModal = ({ userList }) => {
  ...
  console.log(userIdDomainId);
  return (
    <aside className="h-screen z-50 bg-black/80 absolute inset-0 flex flex-row justify-center  items-start p-10">
      <form className="p-5 text-white grow-0 w-1/2 bg-white/20 backdrop-blur-lg rounded-lg flex flex-col gap-3">
